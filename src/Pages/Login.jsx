      ...
      <div className="main flex justify-center">
        <div style={{height:"28rem",marginTop:"8rem"}} className=" rounded login w-[80%] md:w-[30%] shadow-md flex flex-col  p-10 bg-white">
            <h3 className='font-bold text-2xl text-center mb-6'>Login To Your Account</h3>
              ...
              <input onChange={(e)=>setUsername(e.target.value)} type="text" name='username' className='border p-3 h-10 rounded-md mb-4 focus:outline-yellow-400' required/>
              <label htmlFor="password">Password</label>
              <input onChange={(e)=>setPassword(e.target.value)} type="password" name='password' className='p-3 border rounded-md h-10  focus:outline-yellow-400' required/>
